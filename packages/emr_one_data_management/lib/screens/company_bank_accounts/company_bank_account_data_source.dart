...
class CompanyBankAccountDataSource
    extends EmrQueryGraphQLDataSource<CompanyBankAccount> {
  CompanyBankAccountDataSource({
  ...
  Future<void> refresh() async {
    ...
    final response = await referenceDataService.searchCompanyBankAccounts(
    ...
    final companyBankAccounts = response.data!.$1;
    ...
    data.value = companyBankAccounts;
