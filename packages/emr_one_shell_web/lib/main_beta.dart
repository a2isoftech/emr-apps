...
import 'package:emr_one_shell_web/firebase_options_beta.dart';
  ...
  await Startup(
    ...
    endpoints: {
      ...
      'haulage_price_matrix_url':
          'https://haulage-pricing-api-beta.azurewebsites.net',
      ...
      'transportBaseUrl': 'https://transport-api-staging.azurewebsites.net',
      'transportHomePageUrl': 'https://transport-staging.emrgroup.com',
    },
