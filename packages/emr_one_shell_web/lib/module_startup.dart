...
import 'package:emr_one_tickets/routing/tickets_route_registry.dart';
...
import 'package:psnop/routing/psnop_route_registry.dart';
...
class ModuleStartup {
  static Future<void> configure(
    ...
    registry.initRegistrationFunctions([
      ...
      DoorAccessRouteRegistry.register,
      ...
      PsnopRouteRegistry.register,
      SecurityMgmtRouteRegistry.register,
      StockTakeRouteRegistry.register,
      TicketsRouteRegistry.register,
      TransportRouteRegistry.register,
      YardLogisticsRouteRegistry.register,
      YardManagementRouteRegistry.register,
    ]);
