  ...
  static ThemeData lightTheme() {
    ...
    final flexScheme = FlexColorScheme.light(
      ...
      subThemesData: FlexSubThemesData(
        ...
        outlinedButtonTextStyle: WidgetStateProperty.all<TextStyle>(
          TextStyle(
            fontFamily: GoogleFonts.openSans().fontFamily,
            fontSize: 16,
          ),
        ),
        textButtonTextStyle: WidgetStateProperty.all<TextStyle>(
          TextStyle(
            fontFamily: GoogleFonts.openSans().fontFamily,
            fontSize: 16,
          ),
    ...
    final theme = flexScheme.toTheme.copyWith(
      extensions: <ThemeExtension<dynamic>>{
        ...
        EOMenuTheme(
          selectedColour: EmrOneCoreTheme.kSecondary,
        ...
        const EmrScaleTheme(
          disconnectedColor: EmrOneCoreTheme.kError,
          connectedColor: EmrOneCoreTheme.kPrimary,
  ...
  static ThemeData darkTheme() {
    ...
    final theme = flexScheme.toTheme.copyWith(
      extensions: <ThemeExtension<dynamic>>{
        ...
        EOMenuTheme(
          selectedColour: EmrOneCoreTheme.kTertiary,
