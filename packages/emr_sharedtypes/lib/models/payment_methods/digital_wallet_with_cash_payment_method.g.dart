...
part of 'digital_wallet_with_cash_payment_method.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

DigitalWalletWithCashPaymentMethod _$DigitalWalletWithCashPaymentMethodFromJson(
        Map<String, dynamic> json) =>
    DigitalWalletWithCashPaymentMethod(
...
Map<String, dynamic> _$DigitalWalletWithCashPaymentMethodToJson(
        DigitalWalletWithCashPaymentMethod instance) =>
    <String, dynamic>{
