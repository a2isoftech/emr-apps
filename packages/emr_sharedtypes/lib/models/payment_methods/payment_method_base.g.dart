...
part of 'payment_method_base.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

PaymentMethodBase _$PaymentMethodBaseFromJson(Map<String, dynamic> json) =>
    PaymentMethodBase(
...
Map<String, dynamic> _$PaymentMethodBaseToJson(PaymentMethodBase instance) =>
    <String, dynamic>{
