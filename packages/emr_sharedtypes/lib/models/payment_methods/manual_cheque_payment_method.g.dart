...
part of 'manual_cheque_payment_method.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ManualChequePaymentMethod _$ManualChequePaymentMethodFromJson(
        Map<String, dynamic> json) =>
    ManualChequePaymentMethod(
      paymentMethod: $enumDecode(_$PaymentMethodEnumMap, json['paymentMethod']),
      enabled: json['enabled'] as bool,
      maxUpperLimit: (json['maxUpperLimit'] as num).toDouble(),
    );

Map<String, dynamic> _$ManualChequePaymentMethodToJson(
        ManualChequePaymentMethod instance) =>
    <String, dynamic>{
