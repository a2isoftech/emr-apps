...
class _UploadInvoiceState extends State<UploadInvoice> {
  ...
  void initState() {
    super.initState();
    controller = Provider.of<InvoiceEntryController>(context, listen: false);
    textEditingController =
        TextEditingController(text: controller.model.uploadInvoice);
  }
    ...
    return Column(
      children: [
        Padding(
          ...
          child: FormLabel(
            context.l10n.uploadInvoiceTitle,
            mandatory: widget.mandatory,
          ),
        ),
        TextFormField(
          key: const Key(PortalStrings.uploadinvoice),
          decoration:
          ...
          onTap: () async {
            ...
            if (picked != null) {
              if (allowedExtensions.contains(
                ...
                controller.newInvoiceUploadInvoice(
          ...
          readOnly: true,
          validator: (value) =>
              (value ?? '').isEmpty ? context.l10n.uploadInvoiceMessage : null,
        ),
      ],
    );
  }
