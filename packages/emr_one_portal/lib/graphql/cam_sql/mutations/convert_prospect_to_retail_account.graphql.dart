...
class Mutation$ConvertProspectToRetailAccount {
  ...
  int get hashCode {
    ...
    return Object.hashAll([
      l$convertProspectToRetailAccount,
      l$$__typename,
    ]);
  }
...
extension UtilityExtension$Mutation$ConvertProspectToRetailAccount
  ...
  CopyWith$Mutation$ConvertProspectToRetailAccount<
          Mutation$ConvertProspectToRetailAccount>
      get copyWith => CopyWith$Mutation$ConvertProspectToRetailAccount(
            this,
            (i) => i,
          );
}
...
abstract class CopyWith$Mutation$ConvertProspectToRetailAccount<TRes> {
  ...
  CopyWith$Mutation$ConvertProspectToRetailAccount$convertProspectToRetailAccount<
      TRes> get convertProspectToRetailAccount;
}
...
class _CopyWithImpl$Mutation$ConvertProspectToRetailAccount<TRes>
  ...
  TRes call({
    ...
    Object? $__typename = _undefined,
      ...
      _then(Mutation$ConvertProspectToRetailAccount(
        convertProspectToRetailAccount: convertProspectToRetailAccount ==
                _undefined
...
const documentNodeMutationConvertProspectToRetailAccount =
...
abstract class CopyWith$Mutation$ConvertProspectToRetailAccount$convertProspectToRetailAccount<
  ...
  TRes call({
    ...
    List<Mutation$ConvertProspectToRetailAccount$convertProspectToRetailAccount$errors?>?
        errors,
    String? $__typename,
  });
  TRes errors(
      Iterable<Mutation$ConvertProspectToRetailAccount$convertProspectToRetailAccount$errors?>? Function(
              Iterable<
