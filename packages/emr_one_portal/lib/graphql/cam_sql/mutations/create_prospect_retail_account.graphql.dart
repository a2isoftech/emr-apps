...
class Variables$Mutation$CreateProspectRetailAccount {
  ...
  CopyWith$Variables$Mutation$CreateProspectRetailAccount<
      ...
      get copyWith => CopyWith$Variables$Mutation$CreateProspectRetailAccount(
            this,
            (i) => i,
          );
...
class _CopyWithImpl$Variables$Mutation$CreateProspectRetailAccount<TRes>
  ...
  TRes call({Object? input = _undefined}) =>
      _then(Variables$Mutation$CreateProspectRetailAccount._({
        ..._instance._$data,
        if (input != _undefined)
...
extension UtilityExtension$Mutation$CreateProspectRetailAccount
  ...
  CopyWith$Mutation$CreateProspectRetailAccount<
          Mutation$CreateProspectRetailAccount>
      get copyWith => CopyWith$Mutation$CreateProspectRetailAccount(
            this,
            (i) => i,
          );
}
...
class _CopyWithImpl$Mutation$CreateProspectRetailAccount<TRes>
  ...
  TRes call({
    ...
    Object? $__typename = _undefined,
      ...
      _then(Mutation$CreateProspectRetailAccount(
  ...
  CopyWith$Mutation$CreateProspectRetailAccount$createProspectAccount<TRes>
    ...
    return local$createProspectAccount == null
        ...
        : CopyWith$Mutation$CreateProspectRetailAccount$createProspectAccount(
            local$createProspectAccount, (e) => call(createProspectAccount: e));
  }
}
...
const documentNodeMutationCreateProspectRetailAccount =
...
class Mutation$CreateProspectRetailAccount$createProspectAccount {
  ...
  bool operator ==(Object other) {
    ...
    if (!(other
            is Mutation$CreateProspectRetailAccount$createProspectAccount) ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$accountNumber = accountNumber;
...
abstract class CopyWith$Mutation$CreateProspectRetailAccount$createProspectAccount<
  ...
  TRes errors(
      Iterable<Mutation$CreateProspectRetailAccount$createProspectAccount$errors?>? Function(
              Iterable<
...
class _CopyWithImpl$Mutation$CreateProspectRetailAccount$createProspectAccount<
  ...
  final TRes Function(
      Mutation$CreateProspectRetailAccount$createProspectAccount) _then;
  ...
  TRes call({
    ...
    Object? $__typename = _undefined,
      ...
      _then(Mutation$CreateProspectRetailAccount$createProspectAccount(
...
class _CopyWithImpl$Mutation$CreateProspectRetailAccount$createProspectAccount$errors<
  ...
  final TRes Function(
      Mutation$CreateProspectRetailAccount$createProspectAccount$errors) _then;
  ...
  TRes call({
    ...
    Object? $__typename = _undefined,
      ...
      _then(Mutation$CreateProspectRetailAccount$createProspectAccount$errors(
        message:
