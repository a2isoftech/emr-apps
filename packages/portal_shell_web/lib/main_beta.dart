...
import 'package:portal_shell_web/firebase_options_beta.dart';
...
void main() async {
  ...
  await Startup(
    ...
    endpoints: {
      'primaryGateway':
          'https://apim-vpn-test.azure-api.net/accountmanagement-beta2',
      'customerPortalApi': 'https://emr-portalapi-beta.azurewebsites.net',
      'afrApiUrl':
          'https://apim-vpn-test.azure-api.net/accountmanagement-beta2/afr',
...
String loginCallBackUrl(String envEmailLoginCallbackUrl) {
  ...
  const defaultCallBackUrl = 'https://portal-beta.emrgroup.com';
