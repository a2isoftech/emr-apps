...
class Variables$Mutation$AddTags {
  factory Variables$Mutation$AddTags({required Input$AddTagInput input}) =>
      Variables$Mutation$AddTags._({
        r'input': input,
      });

  Variables$Mutation$AddTags._(this._$data);

  factory Variables$Mutation$AddTags.fromJson(Map<String, dynamic> data) {
    final result$data = <String, dynamic>{};
    final l$input = data['input'];
    result$data['input'] =
        Input$AddTagInput.fromJson((l$input as Map<String, dynamic>));
    return Variables$Mutation$AddTags._(result$data);
  }

  Map<String, dynamic> _$data;

  Input$AddTagInput get input => (_$data['input'] as Input$AddTagInput);
  ...
  CopyWith$Variables$Mutation$AddTags<Variables$Mutation$AddTags>
      get copyWith => CopyWith$Variables$Mutation$AddTags(
            this,
            (i) => i,
          );
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Variables$Mutation$AddTags ||
...
abstract class CopyWith$Variables$Mutation$AddTags<TRes> {
  factory CopyWith$Variables$Mutation$AddTags(
    Variables$Mutation$AddTags instance,
    TRes Function(Variables$Mutation$AddTags) then,
  ) = _CopyWithImpl$Variables$Mutation$AddTags;

  factory CopyWith$Variables$Mutation$AddTags.stub(TRes res) =
      _CopyWithStubImpl$Variables$Mutation$AddTags;

  TRes call({Input$AddTagInput? input});
}

class _CopyWithImpl$Variables$Mutation$AddTags<TRes>
    implements CopyWith$Variables$Mutation$AddTags<TRes> {
  _CopyWithImpl$Variables$Mutation$AddTags(
    this._instance,
    this._then,
  );

  final Variables$Mutation$AddTags _instance;

  final TRes Function(Variables$Mutation$AddTags) _then;

  static const _undefined = <dynamic, dynamic>{};

  TRes call({Object? input = _undefined}) =>
      _then(Variables$Mutation$AddTags._({
        ..._instance._$data,
        if (input != _undefined && input != null)
          'input': (input as Input$AddTagInput),
      }));
}

class _CopyWithStubImpl$Variables$Mutation$AddTags<TRes>
    implements CopyWith$Variables$Mutation$AddTags<TRes> {
  _CopyWithStubImpl$Variables$Mutation$AddTags(this._res);

  TRes _res;

  call({Input$AddTagInput? input}) => _res;
}

class Mutation$AddTags {
  Mutation$AddTags({
    required this.addTags,
    this.$__typename = 'Mutation',
  });

  factory Mutation$AddTags.fromJson(Map<String, dynamic> json) {
    final l$addTags = json['addTags'];
    final l$$__typename = json['__typename'];
    return Mutation$AddTags(
      addTags: (l$addTags as List<dynamic>)
          .map((e) =>
              Mutation$AddTags$addTags.fromJson((e as Map<String, dynamic>)))
          .toList(),
      $__typename: (l$$__typename as String),
    );
  }

  final List<Mutation$AddTags$addTags> addTags;
  ...
  Map<String, dynamic> toJson() {
    ...
    _resultData['addTags'] = l$addTags.map((e) => e.toJson()).toList();
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Mutation$AddTags || runtimeType != other.runtimeType) {
      return false;
    }
    final l$addTags = addTags;
...
extension UtilityExtension$Mutation$AddTags on Mutation$AddTags {
  CopyWith$Mutation$AddTags<Mutation$AddTags> get copyWith =>
      CopyWith$Mutation$AddTags(
        this,
        (i) => i,
      );
}

abstract class CopyWith$Mutation$AddTags<TRes> {
  factory CopyWith$Mutation$AddTags(
    Mutation$AddTags instance,
    TRes Function(Mutation$AddTags) then,
  ) = _CopyWithImpl$Mutation$AddTags;

  factory CopyWith$Mutation$AddTags.stub(TRes res) =
      _CopyWithStubImpl$Mutation$AddTags;

  TRes call({
    List<Mutation$AddTags$addTags>? addTags,
    String? $__typename,
  });
  TRes addTags(
      Iterable<Mutation$AddTags$addTags> Function(
              Iterable<
                  CopyWith$Mutation$AddTags$addTags<Mutation$AddTags$addTags>>)
          _fn);
}

class _CopyWithImpl$Mutation$AddTags<TRes>
    implements CopyWith$Mutation$AddTags<TRes> {
  _CopyWithImpl$Mutation$AddTags(
    this._instance,
    this._then,
  );

  final Mutation$AddTags _instance;

  final TRes Function(Mutation$AddTags) _then;
  ...
  TRes call({
    ...
    Object? $__typename = _undefined,
      ...
      _then(Mutation$AddTags(
        addTags: addTags == _undefined || addTags == null
            ? _instance.addTags
            : (addTags as List<Mutation$AddTags$addTags>),
  ...
  TRes addTags(
          Iterable<Mutation$AddTags$addTags> Function(
                  Iterable<
                      CopyWith$Mutation$AddTags$addTags<
                          Mutation$AddTags$addTags>>)
              _fn) =>
      call(
          addTags: _fn(
              _instance.addTags.map((e) => CopyWith$Mutation$AddTags$addTags(
                    e,
                    (i) => i,
                  ))).toList());
}

class _CopyWithStubImpl$Mutation$AddTags<TRes>
    implements CopyWith$Mutation$AddTags<TRes> {
  _CopyWithStubImpl$Mutation$AddTags(this._res);
...
const documentNodeMutationAddTags = DocumentNode(definitions: [
  OperationDefinitionNode(
    type: OperationType.mutation,
    name: NameNode(value: 'AddTags'),
    variableDefinitions: [
      VariableDefinitionNode(
        variable: VariableNode(name: NameNode(value: 'input')),
        type: NamedTypeNode(
          name: NameNode(value: 'AddTagInput'),
          isNonNull: true,
        ),
...
class Mutation$AddTags$addTags {
  Mutation$AddTags$addTags({
    this.id,
  ...
  factory Mutation$AddTags$addTags.fromJson(Map<String, dynamic> json) {
    final l$id = json['id'];
    ...
    final l$$__typename = json['__typename'];
    return Mutation$AddTags$addTags(
      id: (l$id as String?),
      ...
      listItems: (l$listItems as List<dynamic>)
          .map((e) => Mutation$AddTags$addTags$listItems.fromJson(
  ...
  final List<Mutation$AddTags$addTags$listItems> listItems;
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Mutation$AddTags$addTags ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$id = id;
...
extension UtilityExtension$Mutation$AddTags$addTags
    on Mutation$AddTags$addTags {
  CopyWith$Mutation$AddTags$addTags<Mutation$AddTags$addTags> get copyWith =>
      CopyWith$Mutation$AddTags$addTags(
        this,
        (i) => i,
      );
...
abstract class CopyWith$Mutation$AddTags$addTags<TRes> {
  factory CopyWith$Mutation$AddTags$addTags(
    Mutation$AddTags$addTags instance,
    TRes Function(Mutation$AddTags$addTags) then,
  ) = _CopyWithImpl$Mutation$AddTags$addTags;

  factory CopyWith$Mutation$AddTags$addTags.stub(TRes res) =
      _CopyWithStubImpl$Mutation$AddTags$addTags;
  ...
  TRes call({
    ...
    List<Mutation$AddTags$addTags$listItems>? listItems,
    String? $__typename,
  });
  TRes listItems(
      Iterable<Mutation$AddTags$addTags$listItems> Function(
              Iterable<
                  CopyWith$Mutation$AddTags$addTags$listItems<
                      Mutation$AddTags$addTags$listItems>>)
          _fn);
}

class _CopyWithImpl$Mutation$AddTags$addTags<TRes>
    implements CopyWith$Mutation$AddTags$addTags<TRes> {
  _CopyWithImpl$Mutation$AddTags$addTags(
    this._instance,
    this._then,
  );

  final Mutation$AddTags$addTags _instance;

  final TRes Function(Mutation$AddTags$addTags) _then;
  ...
  TRes call({
    ...
    Object? $__typename = _undefined,
      ...
      _then(Mutation$AddTags$addTags(
        ...
        listItems: listItems == _undefined || listItems == null
            ? _instance.listItems
            : (listItems as List<Mutation$AddTags$addTags$listItems>),
        $__typename: $__typename == _undefined || $__typename == null
            ? _instance.$__typename
            : ($__typename as String),
      ));
  ...
  TRes listItems(
      ...
      call(
          listItems: _fn(_instance.listItems
              .map((e) => CopyWith$Mutation$AddTags$addTags$listItems(
                    e,
                    (i) => i,
                  ))).toList());
}

class _CopyWithStubImpl$Mutation$AddTags$addTags<TRes>
    implements CopyWith$Mutation$AddTags$addTags<TRes> {
  _CopyWithStubImpl$Mutation$AddTags$addTags(this._res);
...
class Mutation$AddTags$addTags$listItems {
  Mutation$AddTags$addTags$listItems({
  ...
  factory Mutation$AddTags$addTags$listItems.fromJson(
    ...
    final l$$__typename = json['__typename'];
    return Mutation$AddTags$addTags$listItems(
      ...
      deltas: (l$deltas as List<dynamic>)
          .map((e) => Mutation$AddTags$addTags$listItems$deltas.fromJson(
              (e as Map<String, dynamic>)))
          .toList(),
      tags: (l$tags as List<dynamic>)
          .map((e) => Mutation$AddTags$addTags$listItems$tags.fromJson(
              (e as Map<String, dynamic>)))
          .toList(),
      $__typename: (l$$__typename as String),
    );
  ...
  final List<Mutation$AddTags$addTags$listItems$deltas> deltas;

  final List<Mutation$AddTags$addTags$listItems$tags> tags;
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Mutation$AddTags$addTags$listItems ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$contractLineId = contractLineId;
...
extension UtilityExtension$Mutation$AddTags$addTags$listItems
    on Mutation$AddTags$addTags$listItems {
  CopyWith$Mutation$AddTags$addTags$listItems<
          Mutation$AddTags$addTags$listItems>
      get copyWith => CopyWith$Mutation$AddTags$addTags$listItems(
            this,
            (i) => i,
          );
}

abstract class CopyWith$Mutation$AddTags$addTags$listItems<TRes> {
  factory CopyWith$Mutation$AddTags$addTags$listItems(
    Mutation$AddTags$addTags$listItems instance,
    TRes Function(Mutation$AddTags$addTags$listItems) then,
  ) = _CopyWithImpl$Mutation$AddTags$addTags$listItems;

  factory CopyWith$Mutation$AddTags$addTags$listItems.stub(TRes res) =
      _CopyWithStubImpl$Mutation$AddTags$addTags$listItems;
  ...
  TRes call({
    ...
    List<Mutation$AddTags$addTags$listItems$deltas>? deltas,
    List<Mutation$AddTags$addTags$listItems$tags>? tags,
    String? $__typename,
  });
  TRes deltas(
      Iterable<Mutation$AddTags$addTags$listItems$deltas> Function(
              Iterable<
                  CopyWith$Mutation$AddTags$addTags$listItems$deltas<
                      Mutation$AddTags$addTags$listItems$deltas>>)
          _fn);
  TRes tags(
      Iterable<Mutation$AddTags$addTags$listItems$tags> Function(
              Iterable<
                  CopyWith$Mutation$AddTags$addTags$listItems$tags<
                      Mutation$AddTags$addTags$listItems$tags>>)
          _fn);
}

class _CopyWithImpl$Mutation$AddTags$addTags$listItems<TRes>
    implements CopyWith$Mutation$AddTags$addTags$listItems<TRes> {
  _CopyWithImpl$Mutation$AddTags$addTags$listItems(
    this._instance,
    this._then,
  );

  final Mutation$AddTags$addTags$listItems _instance;

  final TRes Function(Mutation$AddTags$addTags$listItems) _then;
  ...
  TRes call({
    ...
    Object? $__typename = _undefined,
      ...
      _then(Mutation$AddTags$addTags$listItems(
        ...
        deltas: deltas == _undefined || deltas == null
            ? _instance.deltas
            : (deltas as List<Mutation$AddTags$addTags$listItems$deltas>),
        tags: tags == _undefined || tags == null
            ? _instance.tags
            : (tags as List<Mutation$AddTags$addTags$listItems$tags>),
        $__typename: $__typename == _undefined || $__typename == null
            ? _instance.$__typename
            : ($__typename as String),
      ));
  ...
  TRes deltas(
          Iterable<Mutation$AddTags$addTags$listItems$deltas> Function(
              ...
              _fn) =>
      call(
          deltas: _fn(_instance.deltas
              .map((e) => CopyWith$Mutation$AddTags$addTags$listItems$deltas(
                    e,
                    (i) => i,
                  ))).toList());
  ...
  TRes tags(
      ...
      call(
          tags: _fn(_instance.tags
              .map((e) => CopyWith$Mutation$AddTags$addTags$listItems$tags(
                    e,
                    (i) => i,
                  ))).toList());
}

class _CopyWithStubImpl$Mutation$AddTags$addTags$listItems<TRes>
    implements CopyWith$Mutation$AddTags$addTags$listItems<TRes> {
  _CopyWithStubImpl$Mutation$AddTags$addTags$listItems(this._res);
...
class Mutation$AddTags$addTags$listItems$deltas {
  Mutation$AddTags$addTags$listItems$deltas({
    required this.yard,
  ...
  factory Mutation$AddTags$addTags$listItems$deltas.fromJson(
      Map<String, dynamic> json) {
    ...
    final l$$__typename = json['__typename'];
    return Mutation$AddTags$addTags$listItems$deltas(
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Mutation$AddTags$addTags$listItems$deltas ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$yard = yard;
...
extension UtilityExtension$Mutation$AddTags$addTags$listItems$deltas
    on Mutation$AddTags$addTags$listItems$deltas {
  CopyWith$Mutation$AddTags$addTags$listItems$deltas<
          Mutation$AddTags$addTags$listItems$deltas>
      get copyWith => CopyWith$Mutation$AddTags$addTags$listItems$deltas(
            this,
            (i) => i,
          );
}

abstract class CopyWith$Mutation$AddTags$addTags$listItems$deltas<TRes> {
  factory CopyWith$Mutation$AddTags$addTags$listItems$deltas(
    Mutation$AddTags$addTags$listItems$deltas instance,
    TRes Function(Mutation$AddTags$addTags$listItems$deltas) then,
  ) = _CopyWithImpl$Mutation$AddTags$addTags$listItems$deltas;

  factory CopyWith$Mutation$AddTags$addTags$listItems$deltas.stub(TRes res) =
      _CopyWithStubImpl$Mutation$AddTags$addTags$listItems$deltas;
...
class _CopyWithImpl$Mutation$AddTags$addTags$listItems$deltas<TRes>
    implements CopyWith$Mutation$AddTags$addTags$listItems$deltas<TRes> {
  _CopyWithImpl$Mutation$AddTags$addTags$listItems$deltas(
    this._instance,
    this._then,
  );

  final Mutation$AddTags$addTags$listItems$deltas _instance;

  final TRes Function(Mutation$AddTags$addTags$listItems$deltas) _then;
  ...
  TRes call({
    ...
    Object? $__typename = _undefined,
      ...
      _then(Mutation$AddTags$addTags$listItems$deltas(
...
class _CopyWithStubImpl$Mutation$AddTags$addTags$listItems$deltas<TRes>
    implements CopyWith$Mutation$AddTags$addTags$listItems$deltas<TRes> {
  _CopyWithStubImpl$Mutation$AddTags$addTags$listItems$deltas(this._res);
...
class Mutation$AddTags$addTags$listItems$tags {
  Mutation$AddTags$addTags$listItems$tags({
    this.id,
    required this.tagId,
  ...
  factory Mutation$AddTags$addTags$listItems$tags.fromJson(
      Map<String, dynamic> json) {
    final l$id = json['id'];
    ...
    final l$$__typename = json['__typename'];
    return Mutation$AddTags$addTags$listItems$tags(
      id: (l$id as String?),
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Mutation$AddTags$addTags$listItems$tags ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$id = id;
...
extension UtilityExtension$Mutation$AddTags$addTags$listItems$tags
    on Mutation$AddTags$addTags$listItems$tags {
  CopyWith$Mutation$AddTags$addTags$listItems$tags<
          Mutation$AddTags$addTags$listItems$tags>
      get copyWith => CopyWith$Mutation$AddTags$addTags$listItems$tags(
            this,
            (i) => i,
          );
}

abstract class CopyWith$Mutation$AddTags$addTags$listItems$tags<TRes> {
  factory CopyWith$Mutation$AddTags$addTags$listItems$tags(
    Mutation$AddTags$addTags$listItems$tags instance,
    TRes Function(Mutation$AddTags$addTags$listItems$tags) then,
  ) = _CopyWithImpl$Mutation$AddTags$addTags$listItems$tags;

  factory CopyWith$Mutation$AddTags$addTags$listItems$tags.stub(TRes res) =
      _CopyWithStubImpl$Mutation$AddTags$addTags$listItems$tags;
...
class _CopyWithImpl$Mutation$AddTags$addTags$listItems$tags<TRes>
    implements CopyWith$Mutation$AddTags$addTags$listItems$tags<TRes> {
  _CopyWithImpl$Mutation$AddTags$addTags$listItems$tags(
    this._instance,
    this._then,
  );

  final Mutation$AddTags$addTags$listItems$tags _instance;

  final TRes Function(Mutation$AddTags$addTags$listItems$tags) _then;
  ...
  TRes call({
    ...
    Object? $__typename = _undefined,
      ...
      _then(Mutation$AddTags$addTags$listItems$tags(
        id: id == _undefined ? _instance.id : (id as String?),
...
class _CopyWithStubImpl$Mutation$AddTags$addTags$listItems$tags<TRes>
    implements CopyWith$Mutation$AddTags$addTags$listItems$tags<TRes> {
  _CopyWithStubImpl$Mutation$AddTags$addTags$listItems$tags(this._res);
