...
class ManagedThirdPartySettingsDataSource
    extends EmrQueryGraphQLDataSource<UserManagedHauliers> {
  ManagedThirdPartySettingsDataSource({required this.userSettingsService});
  ...
  Future<void> refresh() async {
    ...
    final hauliersList =
        await userSettingsService.getUserManagedHauliers(paginationInfo);
    pageSizeForLastPage =
