...
/// Container-specific locator controller extending base asset locator
/// functionality.
///
...
///
/// This class only needs to implement container-specific behavior:
/// - Asset type constants
/// - Status-to-color mapping
/// - Status count calculations
/// - Service method invocation
class ContainerLocatorController extends BaseAssetLocatorController {
  ...
  /// Asset type enum for containers
  @override
  AssetType get assetType => AssetType.container;

  /// Map container status to marker color category
  @override
  ...
  /// Get counts of containers by status category
  @override
  ...
  /// Fetch containers from service for given geographic bounds
  @override
  Future<List<AssetLocation>> fetchAssetsFromService(
    ...
    if (!response.isSuccess) {
      throw Exception('Failed to fetch container locations.');
    }
