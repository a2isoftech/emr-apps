...
__attribute__((visibility("default"))) __attribute__((used))
ListenerTrampoline_1 _NativeCupertinoHttp_wrapListenerBlock_18v1jvf(ListenerTrampoline_1 block) NS_RETURNS_RETAINED {
...
__attribute__((visibility("default"))) __attribute__((used))
ListenerTrampoline_1 _NativeCupertinoHttp_wrapBlockingBlock_18v1jvf(
...
__attribute__((visibility("default"))) __attribute__((used))
ListenerTrampoline_2 _NativeCupertinoHttp_wrapListenerBlock_xtuoz7(ListenerTrampoline_2 block) NS_RETURNS_RETAINED {
  return ^void(id arg0) {
    objc_retainBlock(block);
...
__attribute__((visibility("default"))) __attribute__((used))
ListenerTrampoline_2 _NativeCupertinoHttp_wrapBlockingBlock_xtuoz7(
