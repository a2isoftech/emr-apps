  ...
  static Future<bool> createZipArchive(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        EmrLogger.event(
          source: 'Ticket Gallery Downloader',
          TicketConstants.kTelemetryGalleryZipOk,
          params: {
            'galleryId': galleryId,
      ...
      EmrLogger.event(
        source: 'Ticket Gallery Downloader',
        TicketConstants.kTelemetryGalleryZipError,
        params: {
          'galleryId': galleryId,
          'imageCount': images.length.toString(),
      ...
      EmrLogger.event(
        source: 'Ticket Gallery Downloader',
        TicketConstants.kTelemetryGalleryZipException,
        params: {
          'galleryId': galleryId,
          'imageCount': images.length.toString(),
