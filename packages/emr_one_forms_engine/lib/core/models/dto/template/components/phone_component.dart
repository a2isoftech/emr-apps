...
class PhoneComponentDTO extends TemplateComponentDTO {
  String? placeholder;
  ...
  factory PhoneComponentDTO.fromJson(Map<String, dynamic> json) =>
      _$PhoneComponentDTOFromJson(json);
}

PhoneComponentDTO _$PhoneComponentDTOFromJson(Map<String, dynamic> json) =>
    PhoneComponentDTO(
        json['id'] as String,
