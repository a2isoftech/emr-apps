...
class InspectionSearchScreenMobile extends StatelessWidget {
  const InspectionSearchScreenMobile({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: ElvVehicleSearch<InspectionResponseModel>(
        ...
        onTap: (data) {
          context.goNamed(
            ...
            params: {
              'identifier':
                  data.vehicleDetail.vin ?? data.vehicleDetail.vehicleReg ?? '',
