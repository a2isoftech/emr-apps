...
class Query$SearchWeighbridgeProfiles$searchWeighbridgeProfiles$nodes {
  ...
  int get hashCode {
    ...
    final l$yardId = yardId;
    final l$$__typename = $__typename;
    return Object.hashAll([l$id, l$yardId, l$$__typename]);
  }
...
> {
  ...
  TRes call({String? id, String? yardId, String? $__typename});
}
...
>
  ...
  call({String? id, String? yardId, String? $__typename}) => _res;
}
