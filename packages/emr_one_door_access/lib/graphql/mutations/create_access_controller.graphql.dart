...
class Variables$Mutation$CreateAccessController {
  ...
  CopyWith$Variables$Mutation$CreateAccessController<
      ...
      get copyWith => CopyWith$Variables$Mutation$CreateAccessController(
            this,
            (i) => i,
          );
...
class _CopyWithImpl$Variables$Mutation$CreateAccessController<TRes>
  ...
  TRes call({Object? input = _undefined}) =>
      _then(Variables$Mutation$CreateAccessController._({
        ..._instance._$data,
...
extension UtilityExtension$Mutation$CreateAccessController
  ...
  CopyWith$Mutation$CreateAccessController<Mutation$CreateAccessController>
      get copyWith => CopyWith$Mutation$CreateAccessController(
            this,
            (i) => i,
          );
}
...
class _CopyWithImpl$Mutation$CreateAccessController<TRes>
  ...
  TRes call({
    ...
    Object? $__typename = _undefined,
      ...
      _then(Mutation$CreateAccessController(
        createAccessController: createAccessController == _undefined ||
                createAccessController == null
...
const documentNodeMutationCreateAccessController = DocumentNode(definitions: [
