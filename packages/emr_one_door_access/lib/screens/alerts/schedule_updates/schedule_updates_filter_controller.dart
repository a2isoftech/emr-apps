...
class ScheduleUpdatesFilterController extends EmrFilterController {
  ScheduleUpdatesFilterController({required this.dataController})
    : super(
  ...
  final ScheduleUpdatesDataController dataController;
