...
class AccountSearchInput {
  ...
  AccountSearchInput.fromJson(Map<String, dynamic> json) {
    ...
    industryGroupTypeFilter = json['industryGroupTypeFilter'] == null
        ? null
        : (json['industryGroupTypeFilter'] as List?)?.cast<String>();
  ...
  AccountSearchInput.fromJsonString(String json) {
    ...
    industryGroupTypeFilter = obj['industryGroupTypeFilter'] == null
        ? null
        : (obj['industryGroupTypeFilter'] as List?)?.cast<String>();
  ...
  late List<String>? industryGroupTypeFilter;
  ...
  Map<String, dynamic> toJson() {
    ...
    data['industryGroupTypeFilter'] = industryGroupTypeFilter;
